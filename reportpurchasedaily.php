	...
	<TR>
		<TD> <DIV ID="purchase_report"> 
	  	...
	  	if(isset($_POST['show'])) {
			...
			$year = $_POST['year'];
			$date = $year . '-'. $month . '-' . $day; 
			print "<p><strong>Purchase Report of date $date</strong></p>";
		} else {
			$date = date('y/m/d');
			print "<p><strong>Today's Purchase Report ($date)</strong></p>";
		}
			...
			print '</table>';
				...
				print "<p>There was no purchase done on that day: $date</p>";
			}
...
<?php
if(PurchaseItem::check($date)) {
print '<div align=center><form method="post" action="printpurchasedaily.php">';
