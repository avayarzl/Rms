	...
	<TR>
		<TD> <DIV ID="purchase_report"> 
	  	...
	  	if(isset($_POST['show'])) {
			...
			print "<p><strong>Purchase Report of Month $month_name/$year</strong></p>";
			...
			print '<p>Total:' .$total . '</p>';
				...
				print "<p>There is no purchase for the month of $month_name, $year</p>";
			}
	}
	  ?>
        </DIV></TD>
...
print '<div align=center><form method="post" action="printpurchasemonthly.php">';
