	...
	<TR>
		<TD> <DIV ID="sales_report"> 
	  	...
	  	if(isset($_POST['show'])) {
			...
			$year = $_POST['year'];
			$date = $year . '-'. $month . '-' . $day; 
			print "<p><strong>Sales Report of date $date</strong></p>";
		} else {
			$date = date('y/m/d');
			print "<p><strong>Today's Sales Report ($date)</strong></p>";
		}
			...
			print '</table>';
				...
				print "<p>There was no sales done on that day: $date</p>";
			}
...
<?php
if(PurchaseItem::check($date)) {
print '<div align=center><form method="post" action="printsalesdaily.php">';
